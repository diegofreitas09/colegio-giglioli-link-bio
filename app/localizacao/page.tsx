          ...
          <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[.82fr_1.18fr] lg:items-center">
            ...
            <AnimatedSection delay={.08}>
              <div className="overflow-hidden rounded-[30px] border border-sky-900/10 bg-white p-2 shadow-2xl shadow-sky-900/10">
                <iframe title="Localização do Colégio Giglioli" src="https://www.google.com/maps?q=R.%20Umarizeiras%2C%20929%20-%20Canindezinho%2C%20Fortaleza%20-%20CE&output=embed" className="h-[470px] w-full rounded-[24px] border-0" loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen />
              </div>
            </AnimatedSection>
          </div>
        </section>
