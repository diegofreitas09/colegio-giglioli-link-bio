    ...
    >
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-2xl">
          <strong id="cookie-consent-title" className="font-[var(--font-display)] text-lg">Privacidade e cookies</strong>
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <button
            ...
            className="rounded-full border border-white/15 bg-white/5 px-5 py-3 text-xs font-black text-white transition-colors hover:bg-white/10"
          >
            Apenas necessários
          </button>
          <button
            ...
            className="rounded-full bg-gradient-to-r from-orange-400 to-yellow-300 px-5 py-3 text-xs font-black text-[#082047] transition-transform hover:-translate-y-0.5"
          >
            Aceitar Analytics
          </button>
        </div>
