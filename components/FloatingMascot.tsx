...
export default function FloatingMascot() {
  return (
    <motion.a
      ...
      className="group fixed bottom-4 right-3 z-[80] flex items-end gap-2 sm:bottom-5 sm:right-5 md:gap-3"
    ...
    >
      <motion.span
        className="relative mb-3 max-w-[180px] rounded-[22px] border border-sky-100/80 bg-white px-4 py-3 text-[12px] font-extrabold leading-snug text-[#0b2b58] shadow-[0_16px_40px_rgba(0,0,0,.24)] sm:max-w-[220px] sm:text-sm"
      ...
      >
        ...
        <span className="absolute -right-2 bottom-4 h-4 w-4 rotate-45 border-r border-b border-sky-100/80 bg-white" aria-hidden="true" />
      </motion.span>
